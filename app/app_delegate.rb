class AppDelegate
  def application(application, didFinishLaunchingWithOptions:launchOptions)
    ...
    challenges_controller = GamesController.alloc.initWithStyle(UITableViewStylePlain)
    ...
    tab_controller.viewControllers = [navigation_controller, games_controller, challenges_controller]
